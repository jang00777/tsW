...
process.load('Configuration.StandardSequences.VtxSmearedNoSmear_cff') # no vtxSmearing
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        pythia8CommonSettings = cms.vstring('Tune:preferLHAPDF = 2', 
            ...
            'ParticleDecays:xyMax = 868',
            'ParticleDecays:zMax = 2200',
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cms/scratch/wjjang/Vts/tsW/mcATnlo/run/tarball/%s_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz' % sname),
...
# Schedule definition
process.schedule = cms.Schedule(process.lhe_step,
