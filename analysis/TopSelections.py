...
def ini():
    import ROOT
    ROOT.gInterpreter.Declare(overlap_code)
    ROOT.gInterpreter.Declare(hadron_code)
...
r.RDataFrame.muonSelection = muonSelection
PyRDF.Proxy.TransformationProxy.muonSelection = muonSelection
r.RDF.RInterface('ROOT::Detail::RDF::RJittedFilter,void').muonSelection = muonSelection
r.RDataFrame.jetSelection = jetSelection
PyRDF.Proxy.TransformationProxy.jetSelection = jetSelection
r.RDF.RInterface('ROOT::Detail::RDF::RJittedFilter,void').jetSelection = jetSelection    
r.RDataFrame.hadronSelection = hadronSelection
PyRDF.Proxy.TransformationProxy.hadronSelection = hadronSelection
r.RDF.RInterface('ROOT::Detail::RDF::RJittedFilter,void').hadronSelection = hadronSelection
