...
int TMVA_JetDiscrimination( TString myMethodList = "" )
{
  ...
  std::cout << std::endl;
  std::cout << "==> Start TMVA_JetDiscrimination" << std::endl;
  ...
  TTree *dilep_bbars_tree       = (TTree*)dilep_bbars->Get("MVA_jet");
  TTree *dilep_bsbar_tree       = (TTree*)dilep_bsbar->Get("MVA_jet");
...
//                                              "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );
  ...
  std::cout << "==> TMVA_JetDiscrimination is done!" << std::endl;
...
int main( int argc, char** argv )
{
  ...
  return TMVA_JetDiscrimination(methodList);
}
